...
export default function(data) {
  ...
  group('POST /live-streaming', function() {
    const url = `${BASE_URL}/live-streaming`;
  ...
  group('PATCH /live-streaming/:id/end', function() {
    const url = `${BASE_URL}/live-streaming/12345/end`;
  ...
  group('GET /live-streaming/live', function() {
    const url = `${BASE_URL}/live-streaming/live`;
  ...
  group('GET /live-streaming/mine', function() {
    const url = `${BASE_URL}/live-streaming/mine`;
