...
export default function(data) {
  ...
  group('GET /exp/me', function() {
    const url = `${BASE_URL}/exp/me`;
  ...
  group('GET /exp/history', function() {
    const url = `${BASE_URL}/exp/history`;
  ...
  group('GET /exp/users/:userId', function() {
    const url = `${BASE_URL}/exp/users/12345`;
