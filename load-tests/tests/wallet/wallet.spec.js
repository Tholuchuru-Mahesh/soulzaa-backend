...
export default function(data) {
  ...
  group('GET /wallet/balance', function() {
  ...
  group('GET /wallet/transactions', function() {
  ...
  group('GET /wallet/earnings', function() {
    const url = `${BASE_URL}/wallet/earnings`;
  ...
  group('GET /wallet/rewards', function() {
    const url = `${BASE_URL}/wallet/rewards`;
  ...
  group('GET /wallet/history', function() {
    const url = `${BASE_URL}/wallet/history`;
