...
export default function(data) {
  ...
  group('POST /casino/rooms/:roomId/window', function() {
    const url = `${BASE_URL}/casino/rooms/12345/window`;
  ...
  group('GET /casino/rooms/:roomId/window', function() {
    const url = `${BASE_URL}/casino/rooms/12345/window`;
  ...
  group('DELETE /casino/rooms/:roomId/window', function() {
    const url = `${BASE_URL}/casino/rooms/12345/window`;
  ...
  group('POST /casino/rooms/:roomId/bet', function() {
    const url = `${BASE_URL}/casino/rooms/12345/bet`;
