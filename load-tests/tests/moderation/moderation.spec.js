...
export default function(data) {
  ...
  group('GET /moderation/live-monitoring', function() {
    const url = `${BASE_URL}/moderation/live-monitoring`;
  ...
  group('GET /moderation/approvals', function() {
    const url = `${BASE_URL}/moderation/approvals`;
  ...
  group('GET /moderation/approvals/:id', function() {
    const url = `${BASE_URL}/moderation/approvals/12345`;
  ...
  group('POST /moderation/approvals/:id/decide', function() {
    const url = `${BASE_URL}/moderation/approvals/12345/decide`;
