...
export default function(data) {
  ...
  group('DELETE /sessions/:id', function() {
    const url = `${BASE_URL}/sessions/12345`;
  ...
  group('POST /sessions/logout-all', function() {
    const url = `${BASE_URL}/sessions/logout-all`;
  ...
  group('POST /sessions/:id/trust', function() {
    const url = `${BASE_URL}/sessions/12345/trust`;
  ...
  group('POST /sessions/:id/untrust', function() {
    const url = `${BASE_URL}/sessions/12345/untrust`;
